...
// Attempt insert query execution
        $sql =  "UPDATE track SET jname='$jname',jadd='$jadd',jcountry='$jcountry',sname='$sname',sadd='$sadd',scountry='$scountry', prod='$prod', mode='$mode', ship_date='$ship_date',ddate='$ddate', currentl= '$currentl', pickupl='$pickupl', status='$status', deliverys='$deliverys', items='$items', descrip='$descrip'   WHERE track_id='$id1' ";
